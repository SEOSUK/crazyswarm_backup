...
class ROSDataBuffer(Node):
    def __init__(self):
        ...
        self.declare_parameter("contact_quat_topic", "/log_player/offline/contact_frame_quat")
        self.declare_parameter("pose_topic", "/log_player/out/pose")
        self.declare_parameter("ee_pose_topic", "/log_player/out/ee_pose")
        self.declare_parameter("vel_cmd_topic", "/log_player/out/cmd_vel")
        self.declare_parameter("vel_actual_topic", "/log_player/out/ee_velocity")
        self.declare_parameter("force_cmd_topic", "")
        self.declare_parameter("force_actual_topic", "/log_player/offline/contact_force_x")
        self.declare_parameter("force_world_topic", "/log_player/online/force_estimate")
        self.declare_parameter("consistency_topic", "/log_player/offline/drone_external_force_mob_2nd_tau_consistency")
        self.declare_parameter("pure_mob_topic", "/log_player/offline/ee_applied_mob_2nd")
        self.declare_parameter("reference_normal_topic", "")
        self.declare_parameter("packed_debug_topic", "/log_player/offline/normal_debug_metrics")
        ...
        vel_cmd_topic = str(self.get_parameter("vel_cmd_topic").value)
        if vel_cmd_topic:
            self.create_subscription(
                Vector3Stamped,
                vel_cmd_topic,
        ...
        vel_actual_topic = str(self.get_parameter("vel_actual_topic").value)
        if vel_actual_topic:
            self.create_subscription(
                Vector3Stamped,
                vel_actual_topic,
        ...
        force_cmd_topic = str(self.get_parameter("force_cmd_topic").value)
        if force_cmd_topic:
            self.create_subscription(
                Float32,
                force_cmd_topic,
        ...
        force_actual_topic = str(self.get_parameter("force_actual_topic").value)
        if force_actual_topic:
            self.create_subscription(
                Float32,
                force_actual_topic,
